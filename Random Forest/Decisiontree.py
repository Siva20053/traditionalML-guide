...
class DecisionTree:
    def __init__(self, min_sample_split=2, max_depth=99, n_features=None):
    ...
    def grow_tree(self,X,y,depth=0):
        ...
        best_feature ,best_threshold = self.best_split(X, y, feats_idxs)
    ...
    def best_split(self, X, y, feats_idxs):
        best_gain = -1
        split_idx = None
        split_thresh = None
